object cadastro_agencias_frm: Tcadastro_agencias_frm
  Left = 666
  Top = 375
  ...
  object Campos_pnl: TPanel
    ...
    object Nm_banco_dbtxt: TDBText
      ...
      AutoSize = True
      DataField = 'NM_BANCO'
      DataSource = agenciasDS
    end
    object nm_agencia_lb: TLabel
      Left = 81
      Top = 83
      Width = 84
      Height = 13
    ...
    object nm_agencia_dbedt: TDBEdit
      Left = 176
      Top = 79
      Width = 297
      Height = 21
  ...
  object agencias_tbl: TTable
    ...
    Left = 520
    Top = 8
    object agencias_tblCD_AGENCIA: TSmallintField
      FieldName = 'CD_AGENCIA'
      Required = True
    end
    object agencias_tblNM_AGENCIA: TStringField
      FieldName = 'NM_AGENCIA'
      Size = 50
    end
    object agencias_tblCD_BANCO: TSmallintField
      FieldName = 'CD_BANCO'
    end
    object agencias_tblNM_BANCO: TStringField
      FieldKind = fkLookup
      FieldName = 'NM_BANCO'
